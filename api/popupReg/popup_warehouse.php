			  ...
			  <table class="table table-bordered table-hover table-striped">
                <thead class="cf" style='background-color: #BDBDBD'>
                  <tr>
					  ...
					  <th class="numeric">창고코드</th>
					  <th class="numeric">창고명</th>
                ...
                <tbody>
				  <?if($result!= 0){while($row = $conn->DBF()){?>
                    <tr>
					  <input type = "hidden" id="ware" value ="<?echo $row['ware_name'];?>">
					  <td data-title="발주 코드"><a class ="dd" data-dismiss="modal" aria-hidden="true"><?echo $row['ware_code'];?></a></td>
					  <td class="numeric" data-title="거래처이름"><?echo $row['ware_name'];?></td>
					  <td class="numeric" data-title="분류"><?echo $row['ware_m'];?></td>
